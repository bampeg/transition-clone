...
export default function BikeTile(props) {
    ...
    return (
        <div className="BikeTile_container">
            <Link to={`/Bikes/${bikeTileTitle}`}><img className="BikeTile_image" src={bikeTileImage} alt="" /></Link>
            <Link to={`/Bikes/${bikeTileTitle}`}><div className="BikeTile_button">{bikeTileTitle}</div></Link>
