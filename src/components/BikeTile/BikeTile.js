...
export default function BikeTile(props) {
    ...
    return (
        <div className="BikeTile_container">
            <Link to={`/${bikeTileTitle}`}><img className="BikeTile_image" src={bikeTileImage} alt=""/></Link>
            <Link to={`/${bikeTileTitle}`}><div className="BikeTile_button">{bikeTileTitle}</div></Link>
